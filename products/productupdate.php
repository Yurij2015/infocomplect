...
if (isset($_GET['id'])) {
    ...
    $category_idcategory = $products->category_idcategory;
}
...
?>
<?php $title = "Редактировать продукт"; ?>
            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="count" id="count" value="<?php echo $count; ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select type="text" class="form-control" name="category_idcategory" id="category_idcategory">
                            ...
                            require_once("../DB.php");
                            ?>
                            <option value="<?php echo $category_idcategory; ?>" selected="selected">
                                <?php $categories = R::load('categories', $category_idcategory);
